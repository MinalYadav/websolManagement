...
public class StafList extends javax.swing.JFrame {
    ...
    public void showStafIncome()
    {
        ...
        try {
            ...
            Logger.getLogger(StafList.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jComboBox3.setBounds(440, 520, 149, 22);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StafList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
