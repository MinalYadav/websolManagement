 ...
 * @author Education
 */
public class UpsateStudent extends javax.swing.JFrame {

    /**
     * Creates new form StudenList
     */
    
    public UpsateStudent() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(1150, 370, 100, 40);
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HomePageJframe/home (1).png"))); // NOI18N
        jPanel5.add(jLabel19);
        jLabel19.setBounds(20, 30, 29, 25);
        jPanel5.add(jSeparator1);
        jSeparator1.setBounds(2, 332, 236, 3);
        jPanel5.add(jSeparator2);
        jSeparator2.setBounds(2, 73, 236, 10);

        jLabel31.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HomePageJframe/icons8-tune-24.png"))); // NOI18N
        jPanel5.add(jLabel31);
        jLabel31.setBounds(20, 100, 24, 20);

        jLabel32.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HomePageJframe/icons8-todo-list-30.png"))); // NOI18N
        jPanel5.add(jLabel32);
        jLabel32.setBounds(20, 150, 30, 30);
        ...
        jLabel33.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HomePageJframe/question.png"))); // NOI18N
        jPanel5.add(jLabel33);
        jLabel33.setBounds(20, 510, 30, 30);
        ...
        jLabel27.setBounds(10, 500, 180, 50);
        ...
        jLabel28.setText("        Update Student");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            Logger.getLogger(UpsateStudent.class.getName()).log(Level.SEVERE, null, ex);
    ...
    int s = Integer.parseInt(JOptionPane.showInputDialog("Enter the following number to update\n"+
       ...
       String q="UPDATE student_info SET Email = ? WHERE Student_Name=?";
         CostmizeDitalesTable.deleStudentData(q, n, email);
           ResultSet rs = CostmizeDitalesTable.seStudentList();
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
       }
       if(s==3)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpsateStudent().setVisible(true);
            }
        });
    }
