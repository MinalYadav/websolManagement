 ...
 * @author Education
 */
public class DropDataH1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(240, 250, 910, 200);
        ...
        jButton1.setBounds(580, 470, 118, 44);
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HomePageJframe/icons8-delete-bin-30.png"))); // NOI18N
        jPanel5.add(jLabel14);
        jLabel14.setBounds(20, 360, 30, 30);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UserFream/list(1).png"))); // NOI18N
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try {
            ...
            Logger.getLogger(DropDataH1.class.getName()).log(Level.SEVERE, null, ex);
        }finally
        {
           try {
               con.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DropDataH1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DropDataH1().setVisible(true);
            }
        });
    }
